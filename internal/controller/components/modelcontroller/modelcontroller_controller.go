...
func (s *componentHandler) NewComponentReconciler(ctx context.Context, mgr ctrl.Manager) error {
	_, err := reconciler.ReconcilerFor(
		...
		WatchesGVK(gvk.ModelMeshServing, reconciler.Dynamic(reconciler.CrdExists(gvk.ModelMeshServing))).
		WithAction(sanitycheck.NewAction(sanitycheck.WithUnwantedResource(gvk.ModelMeshServing, status.ModelMeshServingPresentMessage))).
